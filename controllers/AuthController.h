...
class AuthController : public drogon::HttpController<AuthController>
{
  public:
    ...
    ADD_METHOD_TO(AuthController::selectTenant, "/api/auth/select-tenant", Post, Options);
    METHOD_LIST_END
    ...
    void selectTenant(const HttpRequestPtr &req, std::function<void(const HttpResponsePtr &)> &&callback);
